        ...
        <div className="new-incident-container">
            <div className="content">
                <section>
                    ...
                    <Link className="back-link" to="/profile"> <FiArrowLeft sixe={16} color="#e02041"/> Voltar para a Home</Link>
                </section>
                <form onSubmit={handleNewIncident}>
                    ...
                    <input placeholder="Valor em Reais" value={values} onChange={e => setValues(e.target.value)} />
